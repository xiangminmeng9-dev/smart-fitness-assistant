...
const categories: TipsCategory[] = [
  ...
  },
  {
    ...
    iconBg: 'bg-rose-100',
    tips: [
      '力量训练是抗衰老的基石——维持肌肉量能保持基础代谢和体态挺拔',
      '每周3-5次有氧运动，保护心肺功能，让身体供氧更充足',
      '保证每晚7-8小时高质量睡眠，这是身体修复和激素平衡的关键',
      '控制糖分摄入，减少精加工食品，多摄入优质蛋白和健康脂肪',
      '做好防晒（SPF30+），坚持基础护肤（清洁+保湿+防晒），皮肤状态决定视觉年龄',
      '注意体态——驼背和腹部突出是"显老"的头号杀手，核心训练和拉伸至关重要',
      '保持好奇心和学习习惯，持续给大脑新的刺激',
      '保持社交活跃，与朋友家人的互动能有效缓解压力、提升幸福感',
      '管理压力——长期高压加速衰老，冥想、深呼吸、爱好都是减压利器',
      '关注眼部状态——疲劳的眼神让人显老，保证睡眠和适当的眼部休息',
      '发型和穿搭对"年轻感"影响巨大，定期修剪发型，选择合身的衣物',
    ],
  },
];
